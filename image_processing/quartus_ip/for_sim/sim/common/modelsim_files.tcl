source [file join [file dirname [info script]] ./../../../mult_ip/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../data_store_fifo/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../div_ip/sim/common/modelsim_files.tcl]
...
namespace eval for_sim {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/for_sim.v"]\"  -work for_sim"
    return $design_files
  }
